...
__USER_TEXT L4_INLINE void L4_LoadMRs(int i, int k, L4_Word_t *w)
{
    ...
    /* int all_data_loaded = 0; */

    /* if (i <= 0 && !all_data_loaded) { */
    /*     __L4_MR0 = *w++; */
    /*     if (--k <= 0) */
    /*         all_data_loaded = 1; */
    /* } */
    /* if (i <= 1 && !all_data_loaded) { */
    /*     __L4_MR1 = *w++; */
    /*     if (--k <= 0) */
    /*         all_data_loaded = 1; */
    /* } */
    /* if (i <= 2 && !all_data_loaded) { */
    /*     __L4_MR2 = *w++; */
    /*     if (--k <= 0) */
    /*         all_data_loaded = 1; */
    /* } */
    /* if (i <= 3 && !all_data_loaded) { */
    /*     __L4_MR3 = *w++; */
    /*     if (--k <= 0) */
    /*         all_data_loaded = 1; */
    /* } */
    /* if (i <= 4 && !all_data_loaded) { */
    /*     __L4_MR4 = *w++; */
    /*     if (--k <= 0) */
    /*         all_data_loaded = 1; */
    /* } */
    /* if (i <= 5 && !all_data_loaded) { */
    /*     __L4_MR5 = *w++; */
    /*     if (--k <= 0) */
    /*         all_data_loaded = 1; */
    /* } */
    /* if (i <= 6 && !all_data_loaded) { */
    /*     __L4_MR6 = *w++; */
    /*     if (--k <= 0) */
    /*         all_data_loaded = 1; */
    /* } */
    /* if (i <= 7 && !all_data_loaded) { */
    /*     __L4_MR7 = *w++; */
    /*     if (--k <= 0) */
    /*         all_data_loaded = 1; */
    /* } */
